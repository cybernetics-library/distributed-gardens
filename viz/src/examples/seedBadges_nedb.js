...
var db = new Datastore({ filename: './offlinedb', autoload: true });
...
for (let b in arr) {
  k = (('00000'+b).slice(-5))
    ...
    console.log(k);
      db.insert(msg, function (err, newDoc) {   // Callback is optional
        console.log("SEEDING LOCALLY:: ")
  console.log(msg);
      });
